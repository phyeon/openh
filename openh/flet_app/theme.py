...
# ---- FnD (Fruits & Dessert) family ----
# Dark: Wet Asphalt — ink-black + pink/cyan accents.
...
_FND_DARK = Tokens(
    ...
    BG_ELEVATED="#141726",
    BG_HOVER="#1a1e30",
    BG_SIDEBAR_SELECTED="#181c2e",
    BG_STATUS="#08090e",
    TEXT_PRIMARY="#f0f0f4",
    TEXT_SECONDARY="#8a8fa8",
    TEXT_TERTIARY="#5c6178",
    TEXT_DISABLED="#363a4c",
    TEXT_ON_ACCENT="#0B0C10",
    ACCENT="#FF2DAA",
    ACCENT_DARK="#d4208e",
    ACCENT_HOVER="#ff5ec2",
    ACCENT_PRESSED="#b81878",
    ACCENT_FAINT="#1e0c1c",
    BORDER_FAINT="#1e2338",
    BORDER_SUBTLE="#2a3050",
    BORDER_STRONG="#3e4568",
    ERROR="#ff5a77",
    WARN="#ffc06b",
    SUCCESS="#7af4c0",
    TOOL_CALL_BG="#101320",
    TOOL_CALL_BORDER="#252a42",
    TOOL_RESULT_BG="#0c0e18",
    TOOL_RESULT_BORDER="#1e2236",
    ERROR_BG="#24111a",
)
...
_FND_LIGHT_STRAWBERRY = Tokens(
    ...
    BG_ELEVATED="#FFFFFF",
    BG_HOVER="#FFE8ED",
    BG_SIDEBAR_SELECTED="#FFDDE4",
    BG_STATUS="#FFE8ED",
    TEXT_PRIMARY="#2D1B23",
    TEXT_SECONDARY="#6B4C5A",
    TEXT_TERTIARY="#A8899A",
    TEXT_DISABLED="#D1BABD",
    TEXT_ON_ACCENT="#FFFFFF",
    ACCENT="#E63956",
    ACCENT_DARK="#CC2E48",
    ACCENT_HOVER="#F05A72",
    ACCENT_PRESSED="#B82A42",
    ACCENT_FAINT="#FFE0E6",
    BORDER_FAINT="#F2D6DD",
    BORDER_SUBTLE="#E8C0CA",
    BORDER_STRONG="#D4A0AE",
    ERROR="#D54E58",
    WARN="#C18435",
    SUCCESS="#4C9F82",
    TOOL_CALL_BG="#FFF0F3",
    TOOL_CALL_BORDER="#F2D6DD",
    TOOL_RESULT_BG="#FFF8F9",
    TOOL_RESULT_BORDER="#FAE8ED",
    ERROR_BG="#FFE0E4",
)
...
_FND_LIGHT_MANGO = Tokens(
    ...
    BG_ELEVATED="#FFFFFF",
    BG_HOVER="#FFEDDF",
    BG_SIDEBAR_SELECTED="#FFE2D0",
    BG_STATUS="#FFEDDF",
    TEXT_PRIMARY="#2B1D0E",
    TEXT_SECONDARY="#7A5C3E",
    TEXT_TERTIARY="#B89B7A",
    TEXT_DISABLED="#D4C4B0",
    TEXT_ON_ACCENT="#FFFFFF",
    ACCENT="#FF8243",
    ACCENT_DARK="#E06E35",
    ACCENT_HOVER="#FF9E6A",
    ACCENT_PRESSED="#CC6832",
    ACCENT_FAINT="#FFE8D8",
    BORDER_FAINT="#F0E0CE",
    BORDER_SUBTLE="#E0CAB4",
    BORDER_STRONG="#CCB098",
    ERROR="#D54E58",
    WARN="#C18435",
    SUCCESS="#4C9F82",
    TOOL_CALL_BG="#FFF6EE",
    TOOL_CALL_BORDER="#F0E0CE",
    TOOL_RESULT_BG="#FFFAF5",
    TOOL_RESULT_BORDER="#F7EDE2",
    ERROR_BG="#FFE6E0",
)
...
_FND_LIGHT_BLUEBERRY = Tokens(
    ...
    BG_ELEVATED="#FFFFFF",
    BG_HOVER="#EAE6F4",
    BG_SIDEBAR_SELECTED="#E0DAEE",
    BG_STATUS="#EAE6F4",
    TEXT_PRIMARY="#1A1530",
    TEXT_SECONDARY="#5B5478",
    TEXT_TERTIARY="#9B94B8",
    TEXT_DISABLED="#C8C2D8",
    TEXT_ON_ACCENT="#FFFFFF",
    ACCENT="#6C4BEF",
    ACCENT_DARK="#5A3CD4",
    ACCENT_HOVER="#8A6EFF",
    ACCENT_PRESSED="#5030C0",
    ACCENT_FAINT="#E8E2FF",
    BORDER_FAINT="#E2DDF0",
    BORDER_SUBTLE="#D0C8E4",
    BORDER_STRONG="#B8AED0",
    ERROR="#D54E58",
    WARN="#C18435",
    SUCCESS="#4C9F82",
    TOOL_CALL_BG="#F3F1FA",
    TOOL_CALL_BORDER="#E2DDF0",
    TOOL_RESULT_BG="#F9F8FD",
    TOOL_RESULT_BORDER="#EEEAF7",
    ERROR_BG="#F0E0F0",
)
...
_FND_LIGHT_TROPICAL = Tokens(
    ...
    BG_ELEVATED="#FFFFFF",
    BG_HOVER="#E6EEF0",
    BG_SIDEBAR_SELECTED="#DCE6E8",
    BG_STATUS="#E6EEF0",
    TEXT_PRIMARY="#1A2024",
    TEXT_SECONDARY="#506068",
    TEXT_TERTIARY="#8DA0A8",
    TEXT_DISABLED="#B8C8CE",
    TEXT_ON_ACCENT="#FFFFFF",
    ACCENT="#F06B5D",
    ACCENT_DARK="#D85A4E",
    ACCENT_HOVER="#F88A7E",
    ACCENT_PRESSED="#C04A40",
    ACCENT_FAINT="#FFE4E0",
    BORDER_FAINT="#D8E4E8",
    BORDER_SUBTLE="#C4D4D8",
    BORDER_STRONG="#A8BCC2",
    ERROR="#D54E58",
    WARN="#C18435",
    SUCCESS="#12B7A4",
    TOOL_CALL_BG="#F2F6F7",
    TOOL_CALL_BORDER="#D8E4E8",
    TOOL_RESULT_BG="#F8FBFB",
    TOOL_RESULT_BORDER="#E8F0F2",
    ERROR_BG="#FFE4E0",
)

_register_preset("FnD: Strawberry", _FND_DARK, _FND_LIGHT_STRAWBERRY)
_register_preset("FnD: Mango", _FND_DARK, _FND_LIGHT_MANGO)
_register_preset("FnD: Blueberry", _FND_DARK, _FND_LIGHT_BLUEBERRY)
_register_preset("FnD: Tropical", _FND_DARK, _FND_LIGHT_TROPICAL)
...
def is_fnd() -> bool:
    return _active_preset_name.startswith("FnD:")
