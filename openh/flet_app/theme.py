...
_FND_DARK = Tokens(
    ...
    BG_ELEVATED="#121827",
    BG_HOVER="#1b2437",
    BG_SIDEBAR_SELECTED="#202947",
    BG_STATUS="#080b13",
    TEXT_PRIMARY="#f4f7ff",
    TEXT_SECONDARY="#a6b3d4",
    TEXT_TERTIARY="#69789c",
    TEXT_DISABLED="#3e4965",
    TEXT_ON_ACCENT="#0c1018",
    ACCENT="#ff4fa3",
    ACCENT_DARK="#e23386",
    ACCENT_HOVER="#ff7abf",
    ACCENT_PRESSED="#c71b70",
    ACCENT_FAINT="#26101f",
    BORDER_FAINT="#24304a",
    BORDER_SUBTLE="#334260",
    BORDER_STRONG="#4c5d82",
    ERROR="#ff5277",
    WARN="#ffb45e",
    SUCCESS="#67f7b2",
    TOOL_CALL_BG="#101624",
    TOOL_CALL_BORDER="#2a3654",
    TOOL_RESULT_BG="#0d121e",
    TOOL_RESULT_BORDER="#202b43",
    ERROR_BG="#231019",
)
_FND_LIGHT = Tokens(
    BG_SIDEBAR="#fff1e8dd",
    ...
    BG_ELEVATED="#fffdfb",
    BG_HOVER="#ffece0",
    BG_SIDEBAR_SELECTED="#ffe2d4",
    BG_STATUS="#fff1e8",
    TEXT_PRIMARY="#3a2024",
    TEXT_SECONDARY="#7f5660",
    TEXT_TERTIARY="#b58b93",
    TEXT_DISABLED="#d6bcc2",
    TEXT_ON_ACCENT="#fffaf7",
    ACCENT="#ee6f97",
    ACCENT_DARK="#d75a82",
    ACCENT_HOVER="#ff8fb1",
    ACCENT_PRESSED="#bd4a70",
    ACCENT_FAINT="#ffe2ea",
    BORDER_FAINT="#f4d9cd",
    BORDER_SUBTLE="#eac1b5",
    BORDER_STRONG="#d39f95",
    ERROR="#d74c58",
    WARN="#c8832d",
    SUCCESS="#4dae86",
    TOOL_CALL_BG="#fff0e8",
    TOOL_CALL_BORDER="#efc7bb",
    TOOL_RESULT_BG="#fff7f2",
    TOOL_RESULT_BORDER="#f2d5cb",
    ERROR_BG="#ffe8ea",
)
