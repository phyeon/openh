...
DARK = Tokens(
    ...
    TEXT_PRIMARY="#f0efea",    # --text-000, slightly desaturated
    TEXT_SECONDARY="#b8b5aa",  # --text-200
    TEXT_TERTIARY="#8a8880",   # --text-400
    TEXT_DISABLED="#5a5850",   # --text-500
    TEXT_ON_ACCENT="#f0efea",
