...
# 11. Fruits & Dessert
# Dark: after-hours cyber lounge — 잉크 블랙 + 마젠타/시안 accent.
# Light: pastry editorial — 크림/라즈베리/코코아 톤의 패키지 감성.
_FND_DARK = Tokens(
    BG_SIDEBAR="#09101aee",
    BG_DEEPEST="#04070d",
    BG_PAGE="#070b12",
    BG_ELEVATED="#0d1320",
    BG_HOVER="#121b2a",
    BG_SIDEBAR_SELECTED="#141f31",
    BG_STATUS="#05080e",
    TEXT_PRIMARY="#f7f2ff",
    TEXT_SECONDARY="#a7b3c8",
    TEXT_TERTIARY="#697590",
    TEXT_DISABLED="#3b465c",
    TEXT_ON_ACCENT="#081018",
    ACCENT="#ff4f9c",
    ACCENT_DARK="#d92d76",
    ACCENT_HOVER="#ff7cb9",
    ACCENT_PRESSED="#b91c61",
    ACCENT_FAINT="#1c0f1d",
    BORDER_FAINT="#182335",
    BORDER_SUBTLE="#24314a",
    BORDER_STRONG="#3a4b68",
    ERROR="#ff5a77",
    WARN="#ffc06b",
    SUCCESS="#7af4c0",
    TOOL_CALL_BG="#0d1420",
    TOOL_CALL_BORDER="#24304a",
    TOOL_RESULT_BG="#09111a",
    TOOL_RESULT_BORDER="#1b2740",
    ERROR_BG="#24111a",
)
_FND_LIGHT = Tokens(
    BG_SIDEBAR="#f1e6daee",
    ...
    BG_ELEVATED="#fffaf4",
    BG_HOVER="#f3e7db",
    BG_SIDEBAR_SELECTED="#ead9ca",
    BG_STATUS="#f3e7db",
    TEXT_PRIMARY="#40282d",
    TEXT_SECONDARY="#856167",
    TEXT_TERTIARY="#b18f93",
    TEXT_DISABLED="#d1babd",
    TEXT_ON_ACCENT="#fffaf5",
    ACCENT="#ef5f92",
    ACCENT_DARK="#d94d80",
    ACCENT_HOVER="#ff83ab",
    ACCENT_PRESSED="#bf3d6d",
    ACCENT_FAINT="#fde3eb",
    BORDER_FAINT="#eadcd1",
    BORDER_SUBTLE="#ddc3b7",
    BORDER_STRONG="#c4a094",
    ERROR="#d54e58",
    WARN="#c18435",
    SUCCESS="#4c9f82",
    TOOL_CALL_BG="#fff2ea",
    TOOL_CALL_BORDER="#e8cdc1",
    TOOL_RESULT_BG="#fff9f4",
    TOOL_RESULT_BORDER="#ecd7cb",
    ERROR_BG="#ffe8ea",
)
